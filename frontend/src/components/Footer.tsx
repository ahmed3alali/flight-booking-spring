        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-sm">
              SkyJourney is your trusted partner for booking flights all around the world. 
              We offer an easy-to-use platform with the best prices and excellent customer service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/careers" className="text-white/70 hover:text-white transition text-sm">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/news" className="text-white/70 hover:text-white transition text-sm">
                  News & Media
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help" className="text-white/70 hover:text-white transition text-sm">
                  Help Center
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-6">
              <h3 className="font-bold mb-2 text-lg">Newsletter</h3>
              ...
              <div className="flex">
                <input
                  ...
                  className="px-3 py-2 bg-white/10 text-white placeholder-white/50 rounded-l-md focus:outline-none flex-grow text-sm"
                />
                <button className="bg-airline-red px-3 py-2 rounded-r-md text-sm">
                  Subscribe
                </button>
              </div>
            </div>
